...
impl DiskSys{
  ...
  pub fn new(disk_type: DiskType, name: String, file_system: String, 
    mount_point: String, total_space: String, available_space: String, is_removable: bool) -> Self{
      Self{
        disk_type,
        name,
        file_system,
...
pub fn vec_to_array_disk<'a>(cx: &mut impl Context<'a>, disks: Vec<DiskSys>) -> JsResult<'a, JsArray>{
